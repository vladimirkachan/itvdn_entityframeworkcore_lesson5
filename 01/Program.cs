...
namespace _01
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var companies2 = db.Companies.FromSqlRaw("SELECT * FROM Companies").OrderByDescending(x => x.Name).ToList();
            foreach (var company in companies2) Console.WriteLine(company.Name);
